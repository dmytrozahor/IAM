...
#### IAM-PB1 (Unix-Kommandos)

Führen Sie folgende Schritte in einem Terminal aus.
• Kopieren Sie eine Java-Datei mit der Dateiendung java (z.B. aus Aufgabe 2 oder erstellen
Sie zuvor eine neue) und benennen Sie diese um.

• Erstellen Sie ein neues Verzeichnis und verschieben Sie die eben umbenannte Datei dorthin.

• Wechseln Sie in das neue Verzeichnis und löschen Sie dort alle Dateien mit der Endung java. 
Verwenden Sie dazu die Wildcard *.